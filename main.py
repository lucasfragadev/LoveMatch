...
# Contagem das letras para o primeiro dígito // Counting the letters to the first digit
...
# Contagem das letras para o segundo dígito // Counting the letters to the second digit
...
# Formando o score de compatibilidade // Forming the compatibility score
compatibility = str(first_digit) + str(second_digit)
score = int(compatibility)

# Exibindo o resultado // Showing the result
if score < 10 or score > 90:
    ...
    print(f"Sua pontuação é {score}, vocês estão bem juntos!\n")
else: 
    print(f"\nYour score is {score}")
